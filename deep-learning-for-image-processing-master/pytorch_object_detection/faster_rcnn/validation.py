...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='D:/deep-learning-for-image-processing-master/deep-learning-for-image-processing-master/pytorch_object_detection/faster_rcnn', help='dataset root')
