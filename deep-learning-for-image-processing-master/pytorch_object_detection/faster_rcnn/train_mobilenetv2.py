...
def create_model(num_classes):
    ...
    backbone = MobileNetV2(weights_path="D:/data/torch detection weights/mobilenet_v2.pth").features
...
def main():
    ...
    VOC_root = "D:/data/VOC Data/VOCtrainval_11-May-2012"  # VOCdevkit
