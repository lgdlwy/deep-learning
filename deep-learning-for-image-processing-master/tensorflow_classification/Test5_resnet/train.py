...
def main():
    ...
    image_path=os.path.abspath("D:/data/flower_photos")# flower data set path
    ...
    feature = resnet50(num_classes=1000, include_top=False)
    # feature.save_weights('2.ckpt',save_format='tf')
    ...
    pre_weights_path = 'D:/data/tf classification weights/pretrain_weights.ckpt'
    assert len(glob.glob(pre_weights_path+"*")), "cannot find {}".format(pre_weights_path)
    plot_model(feature, to_file='model.png', show_shapes=False)
    tf.keras.callbacks.TensorBoard().set_model(feature)
