...
def main():
    ...
    data_root = "D:/data/flower_photos"  # get data root path
    ...
    # load weights
    pre_weights_path = 'D:/data/tf classification weights/tf_vit/ViT-B_16.h5'
    ...
    def train_step(train_images, train_labels):
        with tf.GradientTape() as tape:
            ...
            # l2 loss 只计算kernel的l2损失，不计算bias和layernorm的参数损失
